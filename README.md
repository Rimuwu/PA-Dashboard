...
Премиальный аналитический инструмент и тактический симулятор для игры **Planetary Annihilation: TITANS**. Проект разработан с использованием **Vue 3**, **Vite** и **Vanilla CSS**, обеспечивая высокую производительность и плавные анимации.
